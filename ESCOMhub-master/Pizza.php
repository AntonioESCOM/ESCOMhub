            ...
            <div class="row container-fluid">
                <div class="col-sm-5">
                    <div class="mx-auto p-5 text-center">
                        ...
                        <img width="300px" height="156px" src="imgs/image 10 (1).png" class="card-img-top" alt="Pizza">
                        ...
                        <div class="col-6">
                            <div class="card rounded-5">
                                ...
                                <div class="card-body color_card_descrip rounded-5 rounded-top-0 ">
                                    <h6 class="card-title text-center fs-5 letraalef">Rica Pizza de Cotsco, no te la puedes perder</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
