<?php
    ...
    $sql = $conexion2->prepare("SELECT * FROM productos WHERE id=?");
            ...
            <div class="row container-fluid">
                <div class="col-sm-5">
                    <div class="mx-auto p-5 text-center">
                        ...
                        <p class="text-dark fs-5">Fecha de publicación <span>
                            <?php 
                        ...
                        <div class="col-6">
                            <div class="card rounded-5">
                                ...
                                <div class="card-body color_card_descrip rounded-5 rounded-top-0 ">
                                    <h6 class="card-title text-center fs-5 letraalef"><?php echo $row['descripcion'];?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card rounded-5 mb-3">
                                ...
                                <?php
                                    ...
                                    $hora_inicio = DateTime::createFromFormat('H:i:s', $hora_inicio_str);
                                    $hora_fin = DateTime::createFromFormat('H:i:s', $hora_fin_str);

                                    echo "Lunes a Viernes de " . $hora_inicio->format('H:i') . " a " . $hora_fin->format('H:i');
                                    echo'<br>';
